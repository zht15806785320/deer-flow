...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to QianYu Super Intelligent Agent. With its built-in and customizable skills, it can help you search and analyze data, as well as generate slides, images, tables, web pages, and more — it can do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of QianYu. With customized skills,\nQianYu can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. QianYu is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but QianYu could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    // officialWebsite: "QianYu's official website",
    // githubTooltip: "QianYu on Github",
    settingsAndMore: "Settings",
    // visitGithub: "QianYu on GitHub",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to QianYu",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate QianYu faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how QianYu looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "QianYu automatically learns from your conversations in the background. These memories help QianYu understand you better and deliver a more personalized experience.",
    ...
    notification: {
      title: "Notification",
      description:
        "QianYu only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
